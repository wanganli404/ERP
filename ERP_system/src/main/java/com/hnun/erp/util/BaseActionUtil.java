...
public class BaseActionUtil {
	 ...
	 * @param message
	 */
	public static void returnAjax(Boolean success, String message,HttpServletResponse response) {
	 ...
	 * @param jsonString
	 */
	public static void write(String jsonString,HttpServletResponse response) {
